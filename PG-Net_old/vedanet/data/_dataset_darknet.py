...
class DarknetDataset(BramboxDataset):
    ...
    """
    def __init__(self, data_file, augment=True, input_dimension=(512, 128), jitter=.2, flip=.5, hue=.1, saturation=1.5, value=1.5, class_label_map=None):
        def identify(name):
        ...
        if augment:
            ...
            img_tf = vnd_transform.Compose([rc, rf, lb, it])
