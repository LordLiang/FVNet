...
if __name__ == '__main__':
    loss1, empty1 = preprocess('image_sets/train.txt', tag='train')
    loss2, empty2 = preprocess('image_sets/val.txt', tag='val')
    loss3, empty3 = preprocess('image_sets/test.txt', tag='test')
