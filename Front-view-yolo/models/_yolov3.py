...
class Yolov3(YoloABC):
    def __init__(self, num_classes=3, weights_file=None, input_channels=3,
                 anchors=[(14,30),  (15,13),  (22,18), (24,49), (32,23), (48,32), (46,85), (74,49), (113,90)],
                 anchors_mask=[(6,7,8), (3,4,5), (0,1,2)], train_flag=0, clear=False, test_args=None):
