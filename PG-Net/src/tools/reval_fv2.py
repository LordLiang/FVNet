...
from datasets.pascal_fv2 import pascal_fv
import pickle
import os, argparse
import numpy as np
import json
...
def from_dets(detection_file, args):
  imdb = pascal_fv(args.test_split)
...
if __name__ == '__main__':
  args = parse_args()
  print(args.test_split, args.detection_file)
  from_dets(args.detection_file, args)
