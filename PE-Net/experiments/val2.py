...
parser.add_argument('--output_dir', default='../prediction/train', help='Log dir')
...
LOG_FOUT = open(os.path.join(RESULT_DIR, 'log_test_train.txt'), 'w')
LOG_FOUT.write(str(FLAGS)+'\n')

prefix = "/data/dataset/est-kitti/"
DATA_DIR = prefix + "training/"
LIST_FILE = prefix + "list_files/det_train_car_filtered.txt"
LABEL_FILE = prefix + "list_files/label_train_2_car_filtered.txt"
